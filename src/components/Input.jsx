...
function Input({value,onChange, onAdd}) {
    ...
    return (
        <div className="backdrop-blur-2xl max-w-2xl m-auto mt-4 bg-white/5 rounded-2xl border border-white/10 p-3 mb-4 shadow-2xl hover:bg-white/10 transition-all duration-300">
